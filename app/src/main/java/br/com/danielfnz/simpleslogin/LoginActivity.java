...
import br.com.danielfnz.simpleslogin.services.LoginService;
...
public class LoginActivity extends AppCompatActivity  {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new LoginService(this,email, password);
            mAuthTask.execute();
        }
    }
    ...
    public void onEvent(User user){
        ...
        activity.putExtra("nome", user.getNome());
        activity.putExtra("photo_url", user.getPhoto_url());
